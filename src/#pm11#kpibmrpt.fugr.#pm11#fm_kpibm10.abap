...
* Get KPI Description
  SELECT SINGLE l~kpiid,
   ...
   WHERE a~obj_name = '/PM11/FM_KPIBM10'
...
data: lv_high_timestampl  TYPE timestampl,
      lv_low_timestampl   TYPE timestampl,
      lv_tz               TYPE timezone.
 ...
 CONVERT DATE '20210718' TIME '120000'
          INTO TIME STAMP lv_high_timestampl TIME ZONE lv_tz.

 CONVERT DATE '20210717' TIME '000000'
          INTO TIME STAMP lv_low_timestampl TIME ZONE lv_tz.

lv_total_wo = lv_high_timestampl - lv_low_timestampl.
